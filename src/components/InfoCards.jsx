  ...
  const cards = [
    {
      id: 1,
      title: 'Fasilitas',
      description: 'Ruang Kelas, Perpustakaan, Toilet, kantin Dll.',
      icon: (
    ...
    },
    {
      id: 2,
      title: 'Lokasi',
      description: 'Jl. Cumi-cumi Raya No 2, Kec. Semarang Utara, Kota Semarang, Prov. Jawa Tengah.',
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
    ...
    },
    {
      ...
      description: (
        <ul className="list-disc list-inside text-gray-700 space-y-2 text-sm md:text-base">
          <li>Juara 3 Lomba Vokal Group</li>
          <li>Juara 3 Lomba FBBI Cabang Macc. Goggilang Putri</li>
          <li>Juara 3 Lomba FBBI Cabang Macc. Kalegapi Putri</li>
        </ul>
      ),
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
